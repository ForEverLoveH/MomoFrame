...
namespace PEUtils {
    public static class PELog {
        ...
        public static object DLog(object obj)
        {
            if (cfg.enableLog == false)
            {
                return null;
        ...
        public static object DWarn(object obj)
        {
            if (cfg.enableLog == false)
            {
                return null;
        ...
        public static object DError(object obj)
        {
            if (cfg.enableLog == false)
            {
                return null;
